...
public class testGame2 {
	...
	public static void open() throws JsonParseException, JsonMappingException, IOException {
		...
		File file = new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-43.json");
	...
	public JSONArray load(File file) throws JsonParseException, JsonMappingException, IOException {
		...
		public void test1() throws JsonParseException, JsonMappingException, IOException {
			...
			JSONArray jo = load(new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-47.json"));
			int count = 0;
			int x = 0;
			int y = 0;
		...
		public void test2() throws JsonParseException, JsonMappingException, IOException {
			...
			JSONArray jo = load(new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-50.json"));
			int count = 0;
			int x = 0;
			int y = 0;
			StatusData data = new StatusData();
		...
		public void test3() throws JsonParseException, JsonMappingException, IOException {
			...
			JSONArray jo = load(new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-52.json"));
			int count = 0;
			int x = 0;
			int y = 0;
			StatusData data = new StatusData();
		...
		public void test4() throws JsonParseException, JsonMappingException, IOException {
			...
			JSONArray jo = load(new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-56.json"));
			int count = 0;
			int x = 0;
			int y = 0;
			StatusData data = new StatusData();
		...
		public void test5() throws JsonParseException, JsonMappingException, IOException {
			...
			JSONArray jo = load(new File("E:\\JAVAA\\Copy (2) of Game of Life\\test\\test (2)\\2015-05-15-17-14-58.json"));
			int count = 0;
			int x = 0;
			int y = 0;
			StatusData data = new StatusData();
